	...
	public ResetPassword() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
				FileOutputStream fo= new FileOutputStream(new File("admin.txt"));
				...
				// Tester test= new Tester(); test.setVisible(true);
				  ...
				  dispose(); AdminLogin al= new AdminLogin(); al.setVisible(true);
				 
			}
		});
		btnNewButton.setBounds(119, 129, 114, 28);
